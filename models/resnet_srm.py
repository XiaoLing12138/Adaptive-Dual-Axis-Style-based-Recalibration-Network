...
def srm_resnet18(num_classes=3):
...
def srm_resnet34(num_classes=3):
...
def srm_resnet50(num_classes=3):
...
def srm_resnet101(num_classes=3):
...
def spe_resnet152(num_classes=3):
